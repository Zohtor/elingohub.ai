      ...
      <section className="py-20 px-4 bg-gradient-to-br from-gray-50 via-blue-50 to-cyan-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative perspective-[1500px]">
            <div className="relative transform-gpu hover:rotate-y-[-5deg] transition-transform duration-700" style={{ transformStyle: 'preserve-3d' }}>
              {/* 3D Map Container with depth */}
              <div className="relative bg-gradient-to-br from-slate-800 via-blue-900 to-slate-900 rounded-3xl overflow-hidden shadow-2xl p-8 md:p-12">
                {/* Ambient Background Effects */}
                <div className="absolute inset-0 opacity-30">
                  <div className="absolute top-10 left-10 w-64 h-64 bg-blue-400 rounded-full blur-3xl animate-pulse"></div>
                  <div className="absolute bottom-10 right-10 w-64 h-64 bg-cyan-400 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
                ...
                {/* 3D Map with realistic terrain */}
                <div className="relative z-10">
                  <svg viewBox="0 0 120 100" className="w-full h-[400px] md:h-[500px] drop-shadow-2xl" style={{ filter: 'drop-shadow(0 20px 40px rgba(0,0,0,0.3))' }}>
                    <defs>
                      {/* Advanced Gradients for 3D effect */}
                      <linearGradient id="landGradient3D" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <rect x="0" y="0" width="120" height="100" fill="url(#waterGradient3D)" />

                    {/* Animated Water Waves */}
                    <path d="M0,50 Q30,45 60,50 T120,50 L120,100 L0,100 Z" fill="#0ea5e9" opacity="0.3">
                      <animate attributeName="d"
                        values="M0,50 Q30,45 60,50 T120,50 L120,100 L0,100 Z;
                                M0,50 Q30,55 60,50 T120,50 L120,100 L0,100 Z;
                                M0,50 Q30,45 60,50 T120,50 L120,100 L0,100 Z"
                        dur="8s" repeatCount="indefinite"/>
                    </path>

                    {/* Main Land Mass - Estonia with 3D depth */}
                    <g filter="url(#shadow3D)">
                      {/* Base shadow layer */}
                      <path
                        d="M 25,32 Q 30,27 40,30 L 50,27 Q 60,24 70,30 L 80,34 Q 90,37 93,44 L 95,57 Q 93,67 87,72 L 75,77 Q 65,80 55,79 L 40,77 Q 30,74 23,67 L 20,52 Q 21,40 25,32 Z"
                        fill="#000000"
                        opacity="0.2"
                      ...
                      <path
                        d="M 25,32 Q 30,27 40,30 L 50,27 Q 60,24 70,30 L 80,34 Q 90,37 93,44 L 95,57 Q 93,67 87,72 L 75,77 Q 65,80 55,79 L 40,77 Q 30,74 23,67 L 20,52 Q 21,40 25,32 Z"
                        fill="url(#landGradient3D)"
                        stroke="#15803d"
                        strokeWidth="0.5"
                      />

                      {/* Highlight overlay for 3D lighting effect */}
                      <path
                        d="M 25,32 Q 30,27 40,30 L 50,27 Q 60,24 70,30 L 80,34 Q 90,37 93,44 L 95,57 Q 93,67 87,72 L 75,77 Q 65,80 55,79 L 40,77 Q 30,74 23,67 L 20,52 Q 21,40 25,32 Z"
                        fill="url(#highlightGradient)"
                      />

                      {/* Terrain details - forests and elevation */}
                      <circle cx="45" cy="45" r="8" fill="#166534" opacity="0.4" filter="url(#innerShadow)" />
                      <circle cx="65" cy="55" r="6" fill="#166534" opacity="0.3" filter="url(#innerShadow)" />
                      <circle cx="55" cy="40" r="5" fill="#166534" opacity="0.35" filter="url(#innerShadow)" />
                    </g>

                    {/* Cities with 3D pins and glow effects */}
                    {/* Tallinn - Capital */}
                    <g className="hover:scale-110 transition-transform cursor-pointer">
                      <circle cx="53" cy="37" r="4" fill="#3b82f6" opacity="0.3" className="animate-ping" />
                      <circle cx="53" cy="37" r="2.5" fill="#3b82f6" className="animate-pulse" />
                      <circle cx="53" cy="37" r="1.5" fill="#60a5fa" />
                      <line x1="53" y1="37" x2="53" y2="32" stroke="#3b82f6" strokeWidth="0.5" strokeDasharray="1,1" />
                      <rect x="48" y="25" width="10" height="5" rx="1" fill="#1e40af" />
                      <text x="53" y="29" fontSize="2.5" textAnchor="middle" fill="#ffffff" fontWeight="bold">Tallinn</text>
                    </g>

                    {/* Tartu - University City */}
                    <g className="hover:scale-110 transition-transform cursor-pointer">
                      <circle cx="57" cy="60" r="3.5" fill="#8b5cf6" opacity="0.3" className="animate-ping" />
                      <circle cx="57" cy="60" r="2" fill="#8b5cf6" className="animate-pulse" />
                      <circle cx="57" cy="60" r="1.2" fill="#a78bfa" />
                      <line x1="57" y1="60" x2="57" y2="56" stroke="#8b5cf6" strokeWidth="0.5" strokeDasharray="1,1" />
                      <rect x="53.5" y="50" width="7" height="4" rx="0.8" fill="#6b21a8" />
                      <text x="57" y="53" fontSize="2" textAnchor="middle" fill="#ffffff" fontWeight="bold">Tartu</text>
                    </g>

                    {/* Narva - Border City */}
                    <g className="hover:scale-110 transition-transform cursor-pointer">
                      <circle cx="83" cy="44" r="3" fill="#ec4899" opacity="0.3" className="animate-ping" />
                      <circle cx="83" cy="44" r="1.8" fill="#ec4899" className="animate-pulse" />
                      <circle cx="83" cy="44" r="1" fill="#f9a8d4" />
                      <line x1="83" y1="44" x2="83" y2="40.5" stroke="#ec4899" strokeWidth="0.5" strokeDasharray="1,1" />
                      <rect x="80" y="35" width="6" height="3.5" rx="0.7" fill="#9f1239" />
                      <text x="83" y="37.8" fontSize="1.8" textAnchor="middle" fill="#ffffff" fontWeight="bold">Narva</text>
                    </g>

                    {/* Pärnu - Beach Resort */}
                    <g className="hover:scale-110 transition-transform cursor-pointer">
                      <circle cx="43" cy="70" r="3.2" fill="#f59e0b" opacity="0.3" className="animate-ping" />
                      <circle cx="43" cy="70" r="1.9" fill="#f59e0b" className="animate-pulse" />
                      <circle cx="43" cy="70" r="1.1" fill="#fbbf24" />
                      <line x1="43" y1="70" x2="43" y2="66" stroke="#f59e0b" strokeWidth="0.5" strokeDasharray="1,1" />
                      <rect x="39.5" y="60" width="7" height="4" rx="0.8" fill="#92400e" />
                      <text x="43" y="63" fontSize="2" textAnchor="middle" fill="#ffffff" fontWeight="bold">Pärnu</text>
                    </g>

                    {/* Connection Lines between cities */}
                    <line x1="53" y1="37" x2="57" y2="60" stroke="#06b6d4" strokeWidth="0.3" opacity="0.3" strokeDasharray="2,2">
                      <animate attributeName="stroke-dashoffset" values="0;-20" dur="3s" repeatCount="indefinite"/>
                    </line>
                    <line x1="53" y1="37" x2="83" y2="44" stroke="#06b6d4" strokeWidth="0.3" opacity="0.3" strokeDasharray="2,2">
                      <animate attributeName="stroke-dashoffset" values="0;-20" dur="4s" repeatCount="indefinite"/>
                    </line>
                  </svg>

                  {/* Legend with glass morphism effect */}
                  <div className="mt-8 flex items-center justify-center gap-6 flex-wrap">
                    ...
                    <div className="flex items-center gap-3 bg-white/10 backdrop-blur-xl px-6 py-3 rounded-full border border-white/20">
                      ...
                      <span className="text-white font-semibold text-sm">University City</span>
                    </div>
                    <div className="flex items-center gap-3 bg-white/10 backdrop-blur-xl px-6 py-3 rounded-full border border-white/20">
                      <div className="relative">
                        <div className="w-3 h-3 bg-pink-500 rounded-full animate-pulse"></div>
                        <div className="absolute inset-0 w-3 h-3 bg-pink-500 rounded-full animate-ping opacity-30"></div>
                      </div>
                      <span className="text-white font-semibold text-sm">Border City</span>
                    </div>
                    <div className="flex items-center gap-3 bg-white/10 backdrop-blur-xl px-6 py-3 rounded-full border border-white/20">
                      <div className="relative">
                      ...
                      <span className="text-white font-semibold text-sm">Beach Resort</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 left-8 right-8 h-8 bg-gradient-to-b from-gray-800/40 to-transparent rounded-b-3xl blur-xl transform translate-y-2"></div>
            </div>
          </div>
        </div>
      </section>
