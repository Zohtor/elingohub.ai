...
const translations: Record<Language, Record<string, string>> = {
  en: { appName: 'SpeakEstonia.ai', tagline: 'Learn Estonian with AI', subtitle: 'From pronunciation to conversation — your AI tutor helps you every step', freeEntry: 'Free Entry', aiPremiumPlan: 'AI Premium Plan', login: 'Login', createAccount: 'Create Account', myProfile: 'My Profile', logout: 'Logout', discoverEstonia: 'Discover Estonia', interactiveMap: 'Interactive map with real-time facility status', about: 'About', contact: 'Contact', privacy: 'Privacy', terms: 'Terms' },
